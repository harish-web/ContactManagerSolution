...
namespace ContactManager.Infrastructure.Migrations
{
    ...
    [Migration("20241225062856_IdentityTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContacManager.Core.Domain.Entities.Country", b =>
                {
            ...
            modelBuilder.Entity("ContacManager.Core.Domain.Entities.Person", b =>
                {
            ...
            modelBuilder.Entity("ContacManager.Core.Domain.IdentityEntities.ApplicationRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContacManager.Core.Domain.IdentityEntities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ContacManager.Core.Domain.Entities.Person", b =>
                {
                    b.HasOne("ContacManager.Core.Domain.Entities.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("ContacManager.Core.Domain.IdentityEntities.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("ContacManager.Core.Domain.IdentityEntities.ApplicationUser", null)
                        .WithMany()
