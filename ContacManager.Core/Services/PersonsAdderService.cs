...
namespace ContacManager.Core.Services
{
...

    {
        ...
        public PersonsAdderService(IPersonsRepository personsRepository, ICountriesAdderService countriesService)
        {
        ...
        public async Task<PersonResponse> AddPerson(PersonAddRequest personAddRequest)
        {
            ...
            ValidationHelper.Modulvalidation(personAddRequest);


            Person person = personAddRequest.ToPerson();
            person.PersonId = Guid.NewGuid();
            person.TIN = Guid.NewGuid().ToString();
            //persons.Add(person);
            //personsRepository.Add(person);
            await personsRepository.AddPerson(person);
            //await personsRepository.SaveChangesAsync();
            //await personsRepository.SaveChangesAsync();
            //personsRepository.sp_InsertPerson(person);
